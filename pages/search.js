    ...
    return(
        <Wrapper>
            ...
            <ConfirmLocationContainer>
                <Link href={{
                    pathname: pickup && dropOff ? '/confirm': '/search',
                    query:pickup && dropOff ? {
                        pickup:pickup,
                        dropOff:dropOff
                    }:{
                        message: 'locations_should_be_required!'
                    }
                }}>
...
flex items-center bg-white px-4 py-2 font-medium
`
...
bg-black text-white text-xl font-medium w-full py-3 rounded-2 
`